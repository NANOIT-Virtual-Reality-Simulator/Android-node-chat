			...
			boton.setOnClickListener(new OnClickListener() 
			{
				...
				public void onClick(View v)
				{
					...
					{*/
						...
						CharSequence nombreGrupo = txtGrupo.getText();						
						JSONObject obj = new JSONObject();
						obj.put("nombre", nombreGrupo);
						obj.put("propietario", usuario);
						socket.emit("agregarGrupo",obj);
						//listado.
					/*}
					catch(IOException e)
					{				
